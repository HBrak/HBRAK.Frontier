...
{
    public Task<List<T>> GetListFromApiAsync<T>(string apiPath, AccessToken? accessToken = null, int? limit = null, Dictionary<string, string>? extraParams = null) where T : class?;
    ...
    public Task<List<SmartCharacterJump>> GetSmartCharacterJumpsAsync(AccessToken accessToken, int? limit = null);
